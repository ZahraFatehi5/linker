  ...
  invoices: [
    {
      ...
      total: 'علاقه مند به یادگیری مباحث جدید و انجام چالش های برنامه نویسی به خصوص در حوزه دوآپس',
      avatar: '',
      invoiceStatus: 'Paid',
      balance: ['devOps', 'Front end', 'Back end'],
      dueDate: '23 Apr 2019'
    },
    {
      id: 4988,
      ...
      total: 'ذهن خلاق در طراحی های رابط کابری و به دنبال هم تیمی برای رشد مهارت ها',
      avatar: require('@src/assets/images/avatars/10-small.png').default,
      invoiceStatus: 'Downloaded',
      balance:  ['devOps', 'UI/UX'],
      dueDate: '15 Dec 2019'
    },
    {
      id: 4989,
      ...
      total: 'به دنبال کسی که از نقطه صفر باهم برنامه نویسی وب سمت بکند یا فرانت اند رو کار کنیم',
      avatar: require('@src/assets/images/avatars/1-small.png').default,
      invoiceStatus: 'Paid',
      balance:  ['devOps', 'Back end'],
      dueDate: '03 Nov 2019'
    },
    {
      id: 4990,
      ...
      service: 'Software Development',
      total: 'به دنبال هم تیمی برا رسیدن به سطح پیشرفته زبان c++',
    ...
    },
    {
      ...
      service: 'UI/UX Design & Development',
      total: 'علاقه مند به خواندن مباحث جدید و به روز در زمینه شبکه و امنیت',
      avatar: require('@src/assets/images/avatars/10-small.png').default,
      invoiceStatus: 'Draft',
      balance:  ['network'],
      dueDate: '30 Jun 2019'
